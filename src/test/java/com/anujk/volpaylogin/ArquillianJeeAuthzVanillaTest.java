...
import com.anujk.volpaylogin.page.AuthzPage;
...
public class ArquillianJeeAuthzVanillaTest {
    ...
    private static final String APP_NAME = "volpaylogin";
    ...
    public static Archive createTestArchive() throws IOException {
        ...
        return ShrinkWrap.create(WebArchive.class, "volpaylogin.war")
    ...
    public static void cleanUp() throws IOException {
        deleteRealm("admin", "admin", "Volpay");
    }
